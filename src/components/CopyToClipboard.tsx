...
export const CopyToClipboard = (props: CopyToClipboardProps) => {
  ...
  return (
    <div class="relative flex items-center mt-1">
      <button onClick={handleCopy} class="text-gray-500 dark:text-gray-400 hover:brightness-90 rounded-lg pl-2 inline-flex items-center justify-center" title="Copy">
        {copySuccess() ? (
